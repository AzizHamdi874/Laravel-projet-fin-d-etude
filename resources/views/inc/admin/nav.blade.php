...
<nav class="navbar navbar-light navbar-top navbar-expand">
    <div class="navbar-logo"><button class="btn navbar-toggler navbar-toggler-humburger-icon" type="button"
            ...
            <div class="d-flex align-items-center">
                <div class="d-flex align-items-center"><a href="/admin/dashboard"><img
                        src="{{ asset('dashassets/img/icons/amen_logo.png') }}" alt="phoenix" width="95">
                    ...
                    <div class="card bg-white position-relative border-0">
                        <div class="card-body p-0 overflow-auto scrollbar" style="height: 18rem;">
                            ...
                            <ul class="nav d-flex flex-column mb-2 pb-1">
                                ...
                                <li class="nav-item"><a class="nav-link px-3" href="/admin/telescope" target="_blank"><span
                                    class="me-2 text-900" data-feather="settings"></span>Interface de monitoring</a></li>
                                <li class="nav-item"><a class="nav-link px-3" href="/admin/dashboard"><span
                                            class="me-2 text-900"
